  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* ── Header ── */}
        <div
          className={`flex items-start justify-between gap-4 px-8 pb-6 border-b border-gray-100 dark:border-gray-800 flex-shrink-0 ${
            showCover ? "pt-6" : "pt-8"
          }`}
        >
          ...
          {loading ? (
            ...
            <div
              className="prose prose-base dark:prose-invert max-w-none
                ...
                prose-pre:bg-gray-950 dark:prose-pre:bg-gray-900 prose-pre:rounded-xl prose-pre:text-sm
        ...
        {/* ── Footer actions ── */}
        <div className="flex items-center gap-3 px-8 py-5 border-t border-gray-100 dark:border-gray-800 flex-shrink-0">
          <a
            href={repo.html_url}
            target="_blank"
